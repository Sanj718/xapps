...
- [Markets Inline Widget]({{ '/docs/markets-inline-widget/' | relative_url }}) — setup and customization guide
- [Markets Widget]({{ '/docs/dev-markets-widget/' | relative_url }}) — popup version developer reference
