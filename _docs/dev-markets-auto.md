...
- [Markets Auto Redirects]({{ '/docs/markets-auto/' | relative_url }}) — setup and configuration guide
- [UTM & Tracking]({{ '/docs/utm-tracking/' | relative_url }}) — safety parameters and tracking
- [Markets Widget]({{ '/docs/dev-markets-widget/' | relative_url }}) — widget-side developer reference
